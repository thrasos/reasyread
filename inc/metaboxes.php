...
add_action('add_meta_boxes', 'easyread_add_custom_box');
/**
 * Add Meta Boxes.
 *
 * Add Meta box in page and post post types.
 */
function easyread_add_custom_box()
{
    add_meta_box('post-siderbar-layout', //Unique ID
        __('Select layout for this specific Page only ( Note: This setting only reflects if page Template is set as Default Template and Blog Type Templates.)', 'easyread'), //Title
        'easyread_sidebar_layout', //Callback function
        'page' //show metabox in pages
        );
    add_meta_box('page-siderbar-layout', //Unique ID
        __('Select layout for this specific Post only', 'easyread'), //Title
        'easyread_sidebar_layout', //Callback function
    ...
    if ( class_exists( 'WooCommerce' ) ) {
        add_meta_box('product-siderbar-layout', //Unique ID
            __('Select layout for this specific Product only', 'easyread'), //Title
            'easyread_sidebar_layout', //Callback function
 ...
 */
function easyread_sidebar_layout()
{
            ...
            <tr>
                <label class="description"><?php
                    ...
                    <select name="site_layout" id="site_layout">
                        <option value=""><?php _e( 'Default', 'easyread' ); ?></option><?php
...
add_action('save_post', 'easyread_save_custom_meta');
/**
 * save the custom metabox data
 * @hooked to save_post hook
 */
function easyread_save_custom_meta($post_id)
{
    global $site_layout, $post;
